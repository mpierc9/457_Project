...
public class AddEmployeeGUI extends JFrame {
    ...
    public AddEmployeeGUI() {
        ...
        fNameF = new JTextField();  fNameF.setBounds(200,40, 100,30);
        lNameF = new JTextField();  lNameF.setBounds(200,80, 100,30);
        sexF = new JTextField();    sexF.setBounds(200,120, 100,30);
        phoneF = new JTextField();  phoneF.setBounds(200,160, 100,30);
        streetF = new JTextField(); streetF.setBounds(200,200, 100,30);
        cityF = new JTextField();   cityF.setBounds(200,240, 100,30);
        startF = new JTextField();  startF.setBounds(200,280, 100,30);
        dobF = new JTextField("YYYY-MM-DD");    dobF.setBounds(200,320, 100,30);
        payF = new JTextField();    payF.setBounds(200,360, 100,30);
